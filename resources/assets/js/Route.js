...
// import CreateUserContainer from './components/CreateUserComponent';
// import EditUserContainer from './components/EditUserComponent';
    ...
    render() {
        return (
            <Switch>
                ...
                <Route exact path='/register' render={(props) => (this.requireNotAuth(DashboardComponent,props))} />
                ...
                <Route exact path='/user/create' render={(props) => (this.requireAuth(DashboardComponent,props))} />
                <Route path='/user/edit/:id' render={(props) => (this.requireAuth(DashboardComponent,props))} />
            </Switch>
        );
    }
}